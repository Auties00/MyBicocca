...
> **IMPORTANT**: We decided not to use this API module because we discovered Esse3 has a secret REST API.
> This module remains here to show the research that went into creating the application.

## Overview

This module provides a Kotlin client for interacting with the Esse3 student portal, powered by [CINECA](https://www.cineca.it/). 
Unlike modern REST APIs, Esse3 is a traditional server-rendered web application, so this client works entirely through HTML scraping.

...
class Esse3TaxesApi(
    ...
    suspend fun getTaxBills(): List<Esse3TaxBill> {
        ...
        val table = doc.selectFirst("table#tasse-tableFatt")
            ...
            ?: throw HtmlParsingException("Cannot get tax bills: missing tax bills table")
        ...
        return table.parseTable().map { row ->
            ...
            val billId = invoiceCell.selectFirst("a[href*=fatt_id]")
                ...
                ?: throw HtmlParsingException("Cannot get tax bills: missing bill ID for invoice '$invoiceNumber'")
        ...
        val items = if (itemsTable != null) {
            ...
            dataRows.mapNotNull { row ->
                ...
                val academicYear = rowMap["anno"]
                    ?: throw HtmlParsingException("Cannot get tax bill items: missing 'anno' column")

                val installment = rowMap["rata"]
                    ?: throw HtmlParsingException("Cannot get tax bill items: missing 'rata' column")

                val itemDescription = rowMap["voce"]
                    ?: throw HtmlParsingException("Cannot get tax bill items: missing 'voce' column")

                val itemAmountText = rowMap["importo"]
                    ?: throw HtmlParsingException("Cannot get tax bill items: missing 'importo' column")
     ...
     * @throws HtmlParsingException if the bill has no pagoPA info or rptId
     */
    ...
    private fun parseAmount(value: String): BigDecimal {
        ...
        return cleaned.toBigDecimalOrNull()
            ?: throw HtmlParsingException("Invalid amount: $value")
    }
}

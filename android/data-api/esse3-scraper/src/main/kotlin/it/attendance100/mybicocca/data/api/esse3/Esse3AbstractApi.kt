...
abstract class Esse3AbstractApi(
     ...
     * @throws HtmlParsingException if the page is not found or session data is invalid
     */
    ...
    protected fun checkForErrorPage(doc: Document) {
        ...
        if (h2Text.contains("Pagina non trovata", ignoreCase = true)) {
            throw HtmlParsingException("Page not found: the requested page does not exist")
        }

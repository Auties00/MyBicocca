...
data class ElearningGetPublicConfigResponse(
    ...
    val typeoflogin: TypeOfLogin, // The type of login. 1 for app, 2 for browser, 3 for embedded.
    ...
    val identityproviders: List<CoreSiteIdentityProvider>? = null, // Identity providers.
    @SerialName("country")
    ...
    val supportavailability: CoreSiteConfigSupportAvailability? = null,
    ...
    val toolMobileQrCodeType: CoreSiteQRCodeType? = null,
    @SerialName("warnings")
    val warnings: List<CoreWSExternalWarning>? = null,
     ...
     */
    @Serializable
    data class CoreWSExternalWarning(
        @SerialName("item")
     ...
     */
    @Serializable
    enum class CoreSiteInfoUserHomepage(val value: Int) {
        @SerialName("0")
     ...
     */
    @Serializable
    enum class CoreSiteConfigSupportAvailability(val value: Int) {
        @SerialName("0")
        Disabled(0),
        @SerialName("1")
        Authenticated(1),
     ...
     */
    @Serializable
    enum class CoreSiteQRCodeType(val value: Int) {
        @SerialName("0")
     ...
     */
    @Serializable
    data class CoreSiteIdentityProvider(
        @SerialName("name")

        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.personalData.putCareerByStudent(
                    ...
                    body = it.attendance100.mybicocca.data.dto.esse3.Esse3CareerParameters("pirupiru")
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.personalData.putMobilePhone(
                    personId = studentProfile.personId,
                    body = it.attendance100.mybicocca.data.dto.esse3.Esse3MobileParameter()
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.personalData.putDomicilePhone(
                    personId = studentProfile.personId,
                    body = it.attendance100.mybicocca.data.dto.esse3.Esse3PhoneParameters()
                )
            }

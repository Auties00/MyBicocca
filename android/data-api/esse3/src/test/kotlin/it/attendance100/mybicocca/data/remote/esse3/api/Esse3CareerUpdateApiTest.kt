        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.postAddTeachingActivityOffer(
                    it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ProcedureUpdateActivityOfferParameters(
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.putAddTeachingActivityOfferByStudent(
                    ...
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ProcedureUpdateActivityOfferParameters(
                        forceFreeTeachingActivitiesFlag = false,
                        activityIdToUpdate = 0L
                    )
                )
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.postAttendance(
                    it.attendance100.mybicocca.data.remote.esse3.dto.Esse3AttendanceProcedureParameters(
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.putAttendanceByStudent(
                    matId = studentProfile.matId,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3AttendanceProcedureParameters(
                        forceStudentsX = false,
                        forceAttendanceDate = false,
                        forceStateFFlag = false,
                        forceUnplanned = false
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.postRemoveAttendance(
                    it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RemoveAttendanceProcedureParameters(
                        forceStudentsX = false
                    )
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.putRemoveAttendanceByStudent(
                    matId = studentProfile.matId,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RemoveAttendanceProcedureParameters(
                        forceStudentsX = false
                    )
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.postSEG(
                    it.attendance100.mybicocca.data.remote.esse3.dto.Esse3SegmentProcedureParameters(
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.putSEGByStudent(
                    matId = studentProfile.matId,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3SegmentProcedureParameters(
                        forceStateFSFlag = false,
                        forceStudentsX = false,
                        forceFreeTeachingActivitiesFlag = false
                    )
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.postSubstitution(
                    it.attendance100.mybicocca.data.remote.esse3.dto.Esse3SubstitutionProcedureParameters(
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.careerUpdate.putSubstitutionByStudent(
                    matId = studentProfile.matId,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3SubstitutionProcedureParameters(
                        forceStateSFlag = false
                    )
                )
            }

        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.putMassiveAttendance(
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3BulkAttendanceParameters(
                        activityCode = "TEST"
                    )
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.putMassiveDetections(
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3BulkPresenceReleaseParameters(
                        partialCode = "TEST",
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.postRecordBookRow(
                    ...
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ActivitiesToInsert(
                        courseYear = 1,
                        activityType = "OBB"
                    )
                )
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.patchRecordBookRow(
                    matId = studentProfile.matId,
                    activityChoiceId = 1,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PatchTranscriptRow(
                        missionState = "NONE"
                    )
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.setManualAttendance(
                    matId = studentProfile.matId,
                    activityChoiceId = 1,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3SingleAttendanceParameters(
                        choiceStatusCode = "F"
                    )
                )
            }
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.transcript.putRecordBookRowRecognition(
                    matId = studentProfile.matId,
                    activityChoiceId = 1,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RecognitionParameters(
                        searchId = 1,

        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.attachments.postGenericAttachmentMetadata(
                    ...
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3GenericAttachmentInsertMetadata(
                        fileName = "test.txt",
                        author = "test",
        ...
        if (userPermissions.any { it in requiredPermissions }) {
            ...
            assertFailsWith<Esse3Exception> {
                api.attachments.validateAttachment(
                    attachmentType = "GENERICO",
                    attachmentId = 1L,
                    body = it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PatchAttachmentMetadata(validFlag = 1L)
                )
            }

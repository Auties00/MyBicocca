...
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyAgreementsData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyContactData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyConventionStateFilter
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyLocationsData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyPostInput
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyPostOutput
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanyPutInput
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompanySiteTypeFilter
...
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipApplicationQuestionnaireData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipApplicationStateCode
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipCompanyStateFilter
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipEligibilityLanguageCode
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipEligibilityServiceType
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3InternshipEvaluationQuestionnaireTypeFilter
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3OpportunityData
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PermissionLevel
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3StudentInternshipEligibilityData
...
class Esse3InternshipsApi(
    ...
    suspend fun getCompanyConventions(
        ...
        conventionStateCode: Esse3CompanyConventionStateFilter? = null,
        ...
        return executeJsonGetList<Esse3CompanyAgreementsData>("/tirocini/azienda/${companyId}/convenzioni", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            ...
            conventionStateCode?.let { parameter("statoCnvzCod", it.value) }
    ...
    suspend fun getCompanySites(
        ...
        siteTypeCode: Esse3CompanySiteTypeFilter? = null,
        city: String? = null,
        nationId: Long? = null,
        deactivate: Int? = null
        ...
        return executeJsonGetList<Esse3CompanyLocationsData>("/tirocini/azienda/${companyId}/sedi", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            ...
            siteTypeCode?.let { parameter("tipoSedeCod", it.value) }
    ...
    suspend fun getInternshipCompanies(
        ...
        companyStateCode: Esse3InternshipCompanyStateFilter? = null,
        duns: String? = null,
        ...
        return executeJsonGetList<Esse3CompanyData>("/tirocini/aziende", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            ...
            companyStateCode?.let { parameter("statoAziendaCod", it.value) }
    ...
    suspend fun checkStudentInternshipEligibility(
        fiscalCode: String,
        languageCode: Esse3InternshipEligibilityLanguageCode,
        matricola: String? = null,
        serviceType: Esse3InternshipEligibilityServiceType? = null,
        ...
        return executeJsonGetList<Esse3StudentInternshipEligibilityData>("/tirocini/checkEligibilitaStageStu", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            ...
            serviceType?.let { parameter("tipoServizio", it.value) }
            internshipStartDate?.let { parameter("dataIniTiro", it) }
            parameter("codLingua", languageCode.value)
        }
    }
    ...
    suspend fun getStudentInternshipApplicationHeaders(
        studentId: Long,
        internshipApplicationStateCode: Esse3InternshipApplicationStateCode? = null,
        order: String? = null,
        fields: String? = null
        ...
        return executeJsonGetList<Esse3InternshipApplicationHeader>("/tirocini/${studentId}/domande", setOf(Esse3PermissionLevel.STUDENT, Esse3PermissionLevel.TECHNICAL_USER)) {
            internshipApplicationStateCode?.let { parameter("statoDomTiroCod", it.value) }
            order?.let { parameter("order", it) }
            fields?.let { parameter("fields", it) }
        }
    }
    ...
    suspend fun getStudentInternshipEvaluation(
        studentId: Long,
        domicileInternshipId: Long,
        questionTypeCode: Esse3InternshipEvaluationQuestionnaireTypeFilter? = null,
        order: String? = null
        ...
        return executeJsonGetList<Esse3InternshipApplicationQuestionnaireData>("/tirocini/${studentId}/valutazioni/${domicileInternshipId}", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            questionTypeCode?.let { parameter("tipoQuestCod", it.value) }
            order?.let { parameter("order", it) }
        }
    }
}

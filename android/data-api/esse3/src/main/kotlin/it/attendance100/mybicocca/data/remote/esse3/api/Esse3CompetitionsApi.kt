...
import io.ktor.http.contentType
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3Competition
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionAdmissionInsert
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionEnrolled
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionEnrolledDetail
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionRanking
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionRankingFileType
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionRankingList
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionTests
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CompetitionWithDetails
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ImportResponse
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PermissionLevel
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PersonRanking
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RankingImport
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RankingListImport
...
class Esse3CompetitionsApi(
    ...
    suspend fun putCompetitionRanking(
        ...
        fileTypology: Esse3CompetitionRankingFileType
        ...
        return executeJsonPutList<Esse3ImportResponse>("/concorsi/${academicYearId}/${testId}/classifica/${competitionTestsId}", setOf(Esse3PermissionLevel.TECHNICAL_USER)) {
            ...
            setBody(body)
            parameter("tipologiaFile", fileTypology.value)
        }
    }

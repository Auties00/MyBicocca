...
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3AdmissionTitles
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3AdmissionTitlesWithCode
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CourseCharacteristics
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CourseDeadlines
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CourseOfStudySearchFilter
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CoursePositions
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CourseTuitionFees
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3CourseTypes
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3DeletedStudyCourse
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3DisciplinaryArea
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ExternalEntity
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3ExternalEntityTypeFilter
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3Location
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3PermissionLevel
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3RegulationWithPhDSectors
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3StructureWithLocations
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3StudyCourseWithDetails
import it.attendance100.mybicocca.data.remote.esse3.dto.Esse3StudyCourseWithStructure
...
class Esse3StructureApi(
     ...
     *  Accepted values:
     *   - [Esse3CourseOfStudySearchFilter.StruttureDefAmm]: recupera solo se strutture con def_amm_flg e def_amm_old_flg = 1
    ...
    suspend fun getCoursesOfStudy(
        ...
        q: Esse3CourseOfStudySearchFilter? = null,
        start: Int? = null,
        limit: Int? = null,
        order: String? = null
    ...
    suspend fun getCourseAccessTitles(
        courseOfStudyCode: String,
        typologyCode: Esse3TypologyCode
        ...
        return executeJsonGetList<Esse3AdmissionTitlesWithCode>("/corsi/titoli-accesso", setOf(Esse3PermissionLevel.ANY)) {
            parameter("cdsCod", courseOfStudyCode)
            parameter("tipologiaCod", typologyCode.value)
        }
    }
    ...
    suspend fun getExternalEntities(
        ...
        entityType: Esse3ExternalEntityTypeFilter? = null,
        start: Int? = null,
        limit: Int? = null,
        order: String? = null
        ...
        return executeJsonGetList<Esse3ExternalEntity>("/entiEsterni", setOf(Esse3PermissionLevel.ANY)) {
            ...
            entityType?.let { parameter("tipoEnte", it.value) }
            start?.let { parameter("start", it) }
            limit?.let { parameter("limit", it) }
            order?.let { parameter("order", it) }
        }

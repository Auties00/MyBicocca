...
// pre-normalized (normalizeForSearch). Null when fewer than two content words remain —
// single-word titles don't form a meaningful acronym.
...
// Italian + English function words that carry no weight in acronyms or alias matching.
// Mirrors the labeler's set in data/mapper/calendar/SubjectName.kt, which can't be imported
// here (core stays free of data-layer dependencies).

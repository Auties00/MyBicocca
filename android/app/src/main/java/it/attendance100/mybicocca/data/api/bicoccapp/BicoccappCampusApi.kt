...
interface BicoccappCampusApi {
     ...
     *
     * ## Response Structure
     * The [BicoccappPointOfInterestsResponse] object contains categorized location data:
     *
     * ### Buildings
     ...
     *
     * @return A [Response] containing [BicoccappPointOfInterestsResponse] with all campus
     ...
     *
     * ## Response Structure
     * The [BicoccappTeacherResponse] object contains:
     *
     ...
     *
     * @return A [Response] containing [BicoccappTeacherResponse] with the complete profile.

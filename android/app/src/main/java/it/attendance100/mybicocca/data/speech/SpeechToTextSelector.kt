...
// Per-session engine pick: the on-device ML Kit recognizer when its model is installed,
// the platform SpeechRecognizer otherwise. Probing on each dictation keeps the upgrade
// automatic once the device downloads the model.
@Singleton

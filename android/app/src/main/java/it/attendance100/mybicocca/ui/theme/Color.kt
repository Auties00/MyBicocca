...
internal val SurfaceLight = Color(0xFFFFFBFB)
internal val OnSurfaceLight = Color(0xFF211A1B)
internal val SurfaceContainerLowestLight = Color(0xFFFFFFFF)
internal val SurfaceContainerLowLight = Color(0xFFFBF4F4)
internal val SurfaceContainerLight = Color(0xFFF6EEEF)
internal val SurfaceContainerHighLight = Color(0xFFF0E8E9)
internal val SurfaceContainerHighestLight = Color(0xFFEAE0E1)
internal val OnSurfaceVariantLight = Color(0xFF5C4B4E)

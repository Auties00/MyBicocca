...
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.PointOfInterests
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.Teacher
...
interface BicoccappCampusApi {
     ...
     *
     * ## Response Structure
     * The [PointOfInterests] object contains categorized location data:
     *
     * ### Buildings
     ...
     *
     * @return A [Response] containing [PointOfInterests] with all campus
    ...
    suspend fun getPointsOfInterest(): Response<PointOfInterests>
     ...
     *
     * @return A [Response] containing [Teacher] with the complete profile.
    ...
    suspend fun getTeacherByEmail(
        @Query("teacherEmail") email: String? = null
    ): Response<Teacher>
}

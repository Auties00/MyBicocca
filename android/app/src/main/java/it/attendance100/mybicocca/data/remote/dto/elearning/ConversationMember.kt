...
data class ConversationMember(
    ...
    @SerializedName("canmessageevenifblocked") val canMessageEvenIfBlocked: Boolean? = null,
    @SerializedName("canmessage") val canMessage: Boolean? = null,
    @SerializedName("requirescontact") val requiresContact: Boolean? = null,
    @SerializedName("contactrequests") val contactRequests: List<ContactRequest>? = null
)
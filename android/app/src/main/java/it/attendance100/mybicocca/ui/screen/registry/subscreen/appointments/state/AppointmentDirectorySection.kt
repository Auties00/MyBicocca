...
/**
 * A display group of desk services. The portal's raw groups are too granular for a directory
 * (one group per faculty area), so the UI folds them into macro sections.
 */

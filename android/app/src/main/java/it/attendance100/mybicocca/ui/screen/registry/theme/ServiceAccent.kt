...
private val LightServiceAccents = listOf(
    ServiceAccent(Color(0xFFBFDBFE), Color(0xFF1E40AF)), // blue
    ServiceAccent(Color(0xFF99F6E4), Color(0xFF115E59)), // teal
    ServiceAccent(Color(0xFFDDD6FE), Color(0xFF5B21B6)), // violet
    ServiceAccent(Color(0xFFFEF08A), Color(0xFF854D0E)), // amber
    ServiceAccent(Color(0xFFBBF7D0), Color(0xFF166534)), // green
)

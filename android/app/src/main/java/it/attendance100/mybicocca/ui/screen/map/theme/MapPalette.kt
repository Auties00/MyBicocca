...
// applyBicoccaPalette) so the map tracks the active app theme — brand light/dark plus Material You
// and the other palettes. POI icons keep Protomaps' own category colors and are NOT part of this.
data class MapPalette(
    ...
    companion object {
        // Exact brand hexes — identical to the original res/raw / Google cloud style.
        ...
        // Map any M3 scheme onto the base map — used for Material You and the non-brand palettes so
        // the map follows the wallpaper/accent. Mirrors the brand mapping: surface = ground,
        // containers = buildings/water, primary tones = the road/highway accent.

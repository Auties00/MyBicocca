...
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.Calendar
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.CalendarCourses
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.CourseDetail
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.SetCalendarResponse
...
interface BicoccappCalendarApi {
     ...
     *
     * @return A [Response] containing [Calendar] with the scheduled events.
     *
     ...
     *
     * ## Response Structure
     * The [CalendarCourses] object contains:
     ...
     * (add vs. remove).
     *
     * @return A [Response] containing [CalendarCourses] with the course catalog.
     *
    ...
    suspend fun getAvailableCourses(): Response<CalendarCourses>
     ...
     *
     * ## Response Structure
     * The [CourseDetail] object contains:
     *
     * ### Basic Information
     ...
     *
     * @return A [Response] containing [CourseDetail] with course information.
     *
     ...
     *
     * ## Response Structure
     * The [SetCalendarResponse] indicates:
     ...
     *
     * @return A [Response] containing [SetCalendarResponse] with the result.
     *

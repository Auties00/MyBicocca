    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = buildString {
                    append(
                        event.startTime.format(dayOfWeekFormatter)
    ...
    return when (eventStatus) {
        ...
        EventStatus.ENDED -> {
            ...
            when {
                ...
                elapsedMins < 1440 -> stringResource(
                    R.string.event_status_ended_hours,
                    elapsedMins / 60
                )

                elapsedMins < 10080 -> stringResource(
                    R.string.event_status_ended_days,
                    elapsedMins / 1440
                )
        ...
        EventStatus.IN_PROGRESS -> {
            ...
            val elapsedMins = elapsed.toMinutes()
            if (elapsedMins >= 60) stringResource(
                R.string.event_status_in_progress_hours,
                elapsedMins / 60,
                elapsedMins % 60
            )
        ...
        EventStatus.UPCOMING -> {
            ...
            when {
                ...
                untilMins < 1440 -> stringResource(
                    R.string.event_status_starts_hours,
                    untilMins / 60
                )

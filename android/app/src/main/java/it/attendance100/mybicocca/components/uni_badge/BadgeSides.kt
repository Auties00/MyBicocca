...
fun BadgeFrontPreview() {
  ...
  CardFace(
    ...
    content = { x, y, whiteBadge, _ -> BadgeFront(usr, touchX = x, touchY = y, whiteBadge = whiteBadge) },
...
fun BadgeBackPreview() {
  val hazeState = remember { HazeState() }
  CardFace(
    content = { x, y, whiteBadge, hazeState -> BadgeBack(usr, touchX = x, touchY = y, whiteBadge = whiteBadge, hazeState = hazeState) },
    background = PrimaryColor,
    isChromatic = true,
    touchX = 0f,
    touchY = 0f,
...
@Composable
fun BadgeFront(user: User?, textColor: Color = OnBackgroundColor, touchX: Float = 0.5f, touchY: Float = 0.5f, whiteBadge: Boolean) {
  ...
  Box(
    ...
    DitheredTexture(
      modifier = Modifier
          .fillMaxSize()
          .offset(x = (-190 + (-touchX + 0.5f) * (movementCoeff * 1.5)).dp, y = ((-touchY + 0.5f) * (movementCoeff * 1.5)).dp)
          .rotate(10f),
      color = Color.Black,
...
@Composable
fun BadgeBack(user: User?, textColor: Color = MaterialTheme.colorScheme.onBackground, touchX: Float = 0.5f, touchY: Float = 0.5f, whiteBadge: Boolean, hazeState: HazeState) {
  Box(
    modifier = Modifier
        .fillMaxSize()
  ) {
    ...
    DitheredTexture(
      modifier = Modifier
          .fillMaxSize()
          .offset(x = (100 + (-touchX + 0.5f) * (movementCoeff * 1.5)).dp, y = (-50 + (-touchY + 0.5f) * (movementCoeff * 1.5)).dp)
          .rotate(90f),
      color = Color.Black,
      spacing = 10f,          // Distance between dots
      dotSize = 5f,          // Size of the dot
    ...
    Image(
      ...
      modifier = Modifier
          ...
          .size(200.dp)
          .rotate(-7.5f)
          .absoluteOffset(x = (-50 + (-touchX + 0.5f) * (movementCoeff * 1.5)).dp, y = (80 + (-touchY + 0.5f) * (movementCoeff * 0.5)).dp)
    ...
    Image(
      ...
      modifier = Modifier
          .wrapContentSize()
          .size(70.dp)
          .absoluteOffset(x = (-10 + (-touchX + 0.5f) * (movementCoeff * 1.9)).dp, y = (65 + (-touchY + 0.5f) * (movementCoeff * 1)).dp)
          .rotate(20f)
    ...
    Image(
      ...
      modifier = Modifier
          .wrapContentSize()
          .size(80.dp)
          .absoluteOffset(x = (103 + (-touchX + 0.5f) * (movementCoeff * 2.5)).dp, y = (135 + (-touchY + 0.5f) * (movementCoeff * 1)).dp)
          .rotate(20f)
    ...
    Image(
      ...
      modifier = Modifier
          .wrapContentSize()
          .size(40.dp)
          .absoluteOffset(x = (60 + (-touchX + 0.5f) * (movementCoeff * 3)).dp, y = (95 + (-touchY + 0.5f) * (movementCoeff * 1.6)).dp)
          .rotate(-20f)
    ...
    Image(
      ...
      modifier = Modifier
          .wrapContentSize()
          .size(30.dp)
          .absoluteOffset(x = (160 + (-touchX + 0.5f) * (movementCoeff * 3)).dp, y = (200 + (-touchY + 0.5f) * (movementCoeff * 1.5)).dp)
          .rotate(-20f)
    ...
    Image(
      ...
      modifier = Modifier
          .wrapContentSize()
          .size(15.dp)
          .absoluteOffset(x = (120 + (-touchX + 0.5f) * (movementCoeff * 5)).dp, y = (115 + (-touchY + 0.5f) * (movementCoeff * 2)).dp)
          .rotate(40f)

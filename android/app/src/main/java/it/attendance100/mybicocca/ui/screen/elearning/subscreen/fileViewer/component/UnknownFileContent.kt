...
fun UnknownFileContent(
    ...
    Box(modifier = modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        Column(
            ...
            Text(
                text = stringResource(R.string.elearning_file_no_preview),
        ...
        ViewerBottomBar(
            primary = ViewerAction(
                ...
                label = if (downloading) {
                    stringResource(R.string.elearning_file_downloading)
                } else {
                    stringResource(R.string.elearning_file_open_with)
                },
                onClick = onOpenWith,
                enabled = !downloading,
            ),

...
/**
 * The two buckets a booking falls into. Attive = appelli still to sit (today or later,
 * plus any with no date yet); Passate = appelli already sat, the read-only register that
 * carries the outcome.
 */

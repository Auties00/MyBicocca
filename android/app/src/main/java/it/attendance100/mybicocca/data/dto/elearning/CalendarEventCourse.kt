...
data class CalendarEventCourse(
    ...
    @SerializedName("showactivitydates") val showActivityDates: Boolean? = null,
    @SerializedName("showcompletionconditions") val showCompletionConditions: Boolean? = null,
    @SerializedName("fullnamedisplay") val fullNameDisplay: String? = null,
    @SerializedName("viewurl") val viewUrl: String? = null,
    @SerializedName("courseimage") val courseImage: String? = null,

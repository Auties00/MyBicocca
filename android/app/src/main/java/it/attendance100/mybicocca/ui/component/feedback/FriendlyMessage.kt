...
// Shared user-readable error copy for error/empty states across the app. Must not leak internals
// (no class names, no stack traces) — it renders in release builds.

...
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.WizardCategories
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.WizardCourses
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.WizardDegrees
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.WizardLessons
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.WizardUserCourses
...
interface BicoccappWizardApi {
     ...
     *
     * ## Response Structure
     * The [WizardCategories] object contains:
     ...
     *
     * @return A [Response] containing [WizardCategories] with all academic areas.
     *
     * @see getDegreeTypes For the next step after selecting a category
     */
    @GET("wizard/categories")
    suspend fun getCategories(): Response<WizardCategories>
     ...
     *
     * ## Response Structure
     * The [WizardDegrees] object contains:
     ...
     *
     * @return A [Response] containing [WizardDegrees] with available degree types.
     *
     ...
     *
     * ## Response Structure
     * The [WizardCourses] object contains:
     ...
     *
     * @return A [Response] containing [WizardCourses] with degree programs.
     *
     ...
     *
     * ## Response Structure
     * The [WizardLessons] object contains:
     ...
     *
     * @return A [Response] containing [WizardLessons] with course listings.
     *
     ...
     *
     * ## Response Structure
     * The [WizardUserCourses] object contains:
     ...
     *
     * @return A [Response] containing [WizardUserCourses] with the user's courses.
     *

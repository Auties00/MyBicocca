...
import it.attendance100.mybicocca.data.remote.dto.esse3.GetManifestJson200Response
import it.attendance100.mybicocca.data.remote.dto.esse3.GetPageloaded200Response
import it.attendance100.mybicocca.data.remote.dto.esse3.PostChunkuploadend200Response
...
interface Esse3CommonApi {
     ...
     *
     * @return A [Response] containing [GetPageloaded200Response] JSON.
     */
    @GET("PageLoaded.do")
    suspend fun pageLoaded(): Response<GetPageloaded200Response>

    /**
     * Retrieves the web application manifest.
     *
     * @return A [Response] containing [GetManifestJson200Response] JSON.
     */
    @GET("img/layout/favicons/manifest.json")
    suspend fun getManifestJson(): Response<GetManifestJson200Response>
     ...
     * @return A [Response] containing [GetPageloaded200Response].
     */
    @FormUrlEncoded
    @POST("auth/ChunkUploadStart.do")
    suspend fun startChunkUpload(@Field("raw") raw: String? = null): Response<GetPageloaded200Response>
    ...
    suspend fun chunkUpload(): Response<GetPageloaded200Response>

    /**
     * Finalizes the chunked upload.
     *
     * @param raw Raw request data (JSON).
     * @return A [Response] containing [PostChunkuploadend200Response].
     */
    @FormUrlEncoded
    @POST("auth/ChunkUploadEnd.do")
    suspend fun endChunkUpload(@Field("raw") raw: String? = null): Response<PostChunkuploadend200Response>
}

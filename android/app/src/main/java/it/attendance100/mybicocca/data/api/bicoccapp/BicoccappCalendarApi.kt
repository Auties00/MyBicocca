...
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.BicoccappCalendarCoursesResponse
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.BicoccappCalendarResponse
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.BicoccappCourseDetailResponse
import it.attendance100.mybicocca.data.remote.dto.bicoccapp.BicoccappSetCalendarResponse
...
interface BicoccappCalendarApi {
     ...
     *
     * ## Response Structure
     * The [BicoccappCalendarResponse] object contains:
     ...
     *
     * @param matricId Optional enrollment number to fetch the calendar
     ...
     *
     * @return A [Response] containing [BicoccappCalendarResponse] with the scheduled events.
     *
     ...
     *
     * ## Response Structure
     * The [BicoccappCalendarCoursesResponse] object contains:
     ...
     * (add vs. remove).
     *
     * @return A [Response] containing [BicoccappCalendarCoursesResponse] with the course catalog.
     *
     ...
     *
     * ## Response Structure
     * The [BicoccappCourseDetailResponse] object contains:
     *
     * ### Basic Information
     ...
     *
     * @return A [Response] containing [BicoccappCourseDetailResponse] with course information.
     *
     * @see getAvailableCourses For browsing the course catalog
     */
    @GET("course_detail")
    suspend fun getCourseDetail(
        @Query("activityCode") activityCode: String? = null,
        @Query("courseCode") courseCode: String? = null
     ...
     *
     * ## Response Structure
     * The [BicoccappSetCalendarResponse] indicates:
     ...
     *
     * @return A [Response] containing [BicoccappSetCalendarResponse] with the result.
     *
    ...
    suspend fun addCourseToCalendar(
        ...
        @Field("cdsCode") cdsCode: String? = null,
        @Field("activityCode") activityCode: String? = null,
        @Field("lessonName") lessonName: String? = null,
        @Field("courseCode") courseCode: String? = null,
